...
class TooManyInstallsComponent : public juce::Component,
...
public:
    ...
    TooManyInstallsComponent()
    {
        
        
        headerLabel.setText("Device Limit Reached", juce::dontSendNotification);
        headerLabel.setBounds(0, getHeight()*.1, getWidth(), 30);
        headerLabel.setFont(juce::FontOptions(28.0f));
        headerLabel.setColour(juce::Label::textColourId, juce::Colours::white);
        headerLabel.setJustificationType(juce::Justification::centred);
        
        message.setText("You have reached the maximum number of devices allowed", juce::dontSendNotification);
        ...
        message2.setText("To manage your devices, please visit", juce::dontSendNotification);
        message2.setBounds(0, getHeight()*.3, getWidth(), 30);
        message2.setFont(juce::FontOptions(16.0f));
        message2.setColour(juce::Label::textColourId, juce::Colours::white);
        message2.setJustificationType(juce::Justification::centred);
    ...
    void resized() override
    {
        ...
        headerLabel.setBounds(0,getHeight()*-.35f,getWidth(),getHeight());
        message.setBounds(0,getHeight()*-.2f,getWidth(),getHeight());
        message2.setBounds(0,getHeight()*-.1,getWidth(),getHeight());
        okButton.setBounds(getWidth()*.5 - 75,getHeight()*.7,150,40);
        websiteLinkButton.setBounds(0, getHeight()-30, getWidth(),25);
        websiteLinkButton2.setBounds(getWidth()*.5-60,getHeight()*.55- 19,120,20);
