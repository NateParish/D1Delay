...
class SubscriptionExpiredComponent : public juce::Component,
...
public:
    ...
    SubscriptionExpiredComponent()
    {
        ...
        headerLabel.setText("Your subscription has expired", juce::dontSendNotification);
        ...
        message2Right.setText("to resubscribe", juce::dontSendNotification);
